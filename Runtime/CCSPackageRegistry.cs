        ...
        private static CCSPackageDefinition[] BuildLegacyFallbackRegistry()
        {
            return new[]
            {
                ...
                new CCSPackageDefinition(
                    ...
                    CCSPackageSourceType.GitUrl,
                    "https://github.com/Crazy-Carrot-Studios/com.crazycarrot.charactercontroller.git#v0.1.8-preview.1",
                    CCSPackageCategory.OptionalCCS,
                    isRequired: false,
                    defaultSelected: true,
                    autoInstallSupported: true,
                    ...
                    showInPackageHub: false,
                    description:
                    "CCS Base Locomotion preview (pinned tag v0.1.8-preview.1): Humanoid validation, Avatar handoff, Input System 1.18.0 aligned with Hub required packages, default profile under Scripts/Profiles/camera/. UPM installs under Packages/; Hub bootstraps into Assets/CCS/CharacterController then removes the UPM entry.",
                    installNotes:
                    "Git URL includes #v0.1.8-preview.1. UPM resolves under Packages/; Hub copies bootstrappable folders then removes the package dependency. Check Console for [CCS Hub] install/bootstrap version logs.",
